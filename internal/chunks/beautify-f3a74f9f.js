import{S as Bt,i as zt,s as Ot,e as X,k as rt,t as Dt,c as J,a as H,d as F,m as it,J as Nt,h as Pt,b as o,g as ot,H as R,T as tt,W as ft,E as Mt,v as Rt,R as jt,X as It,w as ht,F as et,x as mt,G as nt,V as pt,y as vt,Q as ct,Y as Ut,q as bt,o as yt,B as wt,U as Zt,N as Kt}from"./index-6cf2f089.js";import{c as Lt,T as qt,n as lt}from"./ToastContainer-9889b43d.js";import{T as Vt}from"./TippyStyles-d450c535.js";import{t as dt}from"./tooltip-899db86d.js";import"./index-784d3c4b.js";import"./index-051c2ec7.js";function Gt(p,k,a={}){const g=Object.assign({tab:"	",indentOn:/[({\[]$/,moveToNewLine:/^[)}\]]/,spellcheck:!1,catchTab:!0,preserveIdent:!0,addClosing:!0,history:!0,window:globalThis},a),y=g.window,v=y.document;let j=[],s=[],A=-1,x=!1,O,M;p.setAttribute("contenteditable","plaintext-only"),p.setAttribute("spellcheck",g.spellcheck?"true":"false"),p.style.outline="none",p.style.overflowWrap="break-word",p.style.overflowY="auto",p.style.whiteSpace="pre-wrap";let N=!1;k(p),p.contentEditable!=="plaintext-only"&&(N=!0),N&&p.setAttribute("contenteditable","true");const q=L(()=>{const n=t();k(p,n),e(n)},30);let C=!1;const T=n=>!U(n)&&!Q(n)&&n.key!=="Meta"&&n.key!=="Control"&&n.key!=="Alt"&&!n.key.startsWith("Arrow"),_=L(n=>{T(n)&&(E(),C=!1)},300),m=(n,u)=>{j.push([n,u]),p.addEventListener(n,u)};m("keydown",n=>{n.defaultPrevented||(M=I(),g.preserveIdent?i(n):d(n),g.catchTab&&h(n),g.addClosing&&w(n),g.history&&(S(n),T(n)&&!C&&(E(),C=!0)),N&&e(t()))}),m("keyup",n=>{n.defaultPrevented||n.isComposing||(M!==I()&&q(),_(n),O&&O(I()))}),m("focus",n=>{x=!0}),m("blur",n=>{x=!1}),m("paste",n=>{E(),Z(n),E(),O&&O(I())});function t(){const n=P(),u={start:0,end:0,dir:void 0};let{anchorNode:f,anchorOffset:c,focusNode:b,focusOffset:$}=n;if(!f||!b)throw"error1";if(f.nodeType===Node.ELEMENT_NODE){const z=v.createTextNode("");f.insertBefore(z,f.childNodes[c]),f=z,c=0}if(b.nodeType===Node.ELEMENT_NODE){const z=v.createTextNode("");b.insertBefore(z,b.childNodes[$]),b=z,$=0}return at(p,z=>{if(z===f&&z===b)return u.start+=c,u.end+=$,u.dir=c<=$?"->":"<-","stop";if(z===f)if(u.start+=c,!u.dir)u.dir="->";else return"stop";else if(z===b)if(u.end+=$,!u.dir)u.dir="<-";else return"stop";z.nodeType===Node.TEXT_NODE&&(u.dir!="->"&&(u.start+=z.nodeValue.length),u.dir!="<-"&&(u.end+=z.nodeValue.length))}),p.normalize(),u}function e(n){const u=P();let f,c=0,b,$=0;if(n.dir||(n.dir="->"),n.start<0&&(n.start=0),n.end<0&&(n.end=0),n.dir=="<-"){const{start:D,end:W}=n;n.start=W,n.end=D}let z=0;at(p,D=>{if(D.nodeType!==Node.TEXT_NODE)return;const W=(D.nodeValue||"").length;if(z+W>n.start&&(f||(f=D,c=n.start-z),z+W>n.end))return b=D,$=n.end-z,"stop";z+=W}),f||(f=p,c=p.childNodes.length),b||(b=p,$=p.childNodes.length),n.dir=="<-"&&([f,c,b,$]=[b,$,f,c]),u.setBaseAndExtent(f,c,b,$)}function r(){const u=P().getRangeAt(0),f=v.createRange();return f.selectNodeContents(p),f.setEnd(u.startContainer,u.startOffset),f.toString()}function l(){const u=P().getRangeAt(0),f=v.createRange();return f.selectNodeContents(p),f.setStart(u.endContainer,u.endOffset),f.toString()}function i(n){if(n.key==="Enter"){const u=r(),f=l();let[c]=B(u),b=c;if(g.indentOn.test(u)&&(b+=g.tab),b.length>0?(K(n),n.stopPropagation(),G(`
...
`),_.hasAttribute("data-start")||_.setAttribute("data-start",String(h+1))}m.textContent=i,a.highlightElement(m)},function(i){_.setAttribute(s,O),m.textContent=i})}}),a.plugins.fileHighlight={highlight:function(_){for(var m=(_||document).querySelectorAll(M),t=0,e;e=m[t++];)a.highlightElement(e)}};var C=!1;a.fileHighlight=function(){C||(console.warn("Prism.fileHighlight is deprecated. Use `Prism.plugins.fileHighlight.highlight` instead."),C=!0),a.plugins.fileHighlight.highlight.apply(this,arguments)}}()})(Ht);var $t=Ht.exports;function Wt(p){let k,a,g,y,v,j,s,A;return{c(){k=X("div"),a=X("div"),y=rt(),v=X("style"),j=Dt(`/*
    ...
    */
     ...
     */
		...
		}`),this.h()},l(x){k=J(x,"DIV",{id:!0,class:!0});var O=H(k);a=J(O,"DIV",{id:!0,class:!0}),H(a).forEach(F),O.forEach(F),y=it(x);const M=Nt('[data-svelte="svelte-1ahzjnp"]',document.head);v=J(M,"STYLE",{});var N=H(v);j=Pt(N,`/*
